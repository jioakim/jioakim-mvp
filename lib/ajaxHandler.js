...
exports.getInit = function(callback) {
  axios.get('http://165.227.174.222:3123/api/result')
...
exports.getFirstName = function(firstName, callback) {
  axios.get('http://165.227.174.222:3123/api/result/' + firstName)
  .then(function(response) {
    callback(response.data);
  });
}
...
exports.postUserInputSubmit = function(userTextInput, callback) {
  ...
  axios.post('http://165.227.174.222:3123/api/result', postObject)
  .then(function(response){
    callback(response.data);
  });
}
...
exports.deleteFirstName = function(fnId, callback) {
  axios.delete('http://165.227.174.222:3123/api/result/' + fnId)
  .then(function(response){
...
exports.addFirstName = function(firstName, callback) {
  axios.post('http://165.227.174.222:3123/api/result/' + firstName)
  .then(function(response){
    callback(response.data);
  }).catch(function (error) {
    console.log(error);
...
exports.updateFisrtName = function(fnId, fnUpdated, callback) {
  ...
  axios.put('http://165.227.174.222:3123/api/result/' + fnId, updatedFirstName)
  .then(function(response) {
    callback(response.data);
  }).catch(function (error) {
    console.log(error);
